...
<div class="section rounded bg-dark">
    <h2><i class="fa-solid fa-people-group"></i>Usuários  (<?=mysqli_num_rows(mysqli_query($conn, "SELECT id FROM usuarios"))?>)</h2>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <a href="pedido_detalhes.php?id=<?=$pedido['id']?>" class="btn btn-primary btn-sm">👁️</a>
                        </div>
                    </div>
                </div>
            </div>
